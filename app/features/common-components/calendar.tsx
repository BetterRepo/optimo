...
import { buttonVariants } from "@/app/features/common-components/button"
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-green-900 text-neutral-50 hover:bg-neutral-900 hover:text-neutral-50 focus:bg-green-600 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
