...
interface DynamicValidationMessageProps {
  message: string;
}

export const DynamicValidationMessage: React.FC<DynamicValidationMessageProps> = ({ message }) => {
  return (
...
export default DynamicValidationMessage; 