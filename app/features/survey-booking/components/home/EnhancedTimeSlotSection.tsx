...
export const EnhancedTimeSlotSection: React.FC<
  EnhancedTimeSlotSectionProps
> = ({
  formData,
  showSlots,
  loading,
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                Next-day appointments are not available after 5:00 PM PST. If
                you're booking after the cutoff time, the earliest available
                date will be 2 days out.
              </p>
            </div>
          </div>
        </div>
