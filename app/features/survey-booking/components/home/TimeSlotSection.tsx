...
export const TimeSlotSection: React.FC<TimeSlotSectionProps> = ({
  ...
  useEffect(() => {
    if (preferredDates.length > 0 && onUpdateFormData) {
      ...
      const formattedDates = preferredDates.map(
  ...
  const shouldShowErrorMessage = (
    ...
    if (selectedDate) {
      ...
      if (
        dateStr === "2025-04-25" &&
        message.includes("tomorrow is not available")
      ) {
        return false;
      }
    }
  ...
  return (
    <div>
      ...
      <div className="w-full">
        ...
        errorMessage.includes("Geocoder did not return an exact match") ? (
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    Please select any available slot you like. This reserves
                    your preferred slot - you&apos;ll receive a specific 2-hour
                    arrival window the evening before via text and email.
            ...
            <div className="grid sm:grid-cols-2">
              ...
              <div className="slots-container mt-12 col-span-1 flex flex-col items-center justify-center">
                {loading ? (
                  ...
                  shouldShowErrorMessage(errorMessage, selectedDate) ? (
