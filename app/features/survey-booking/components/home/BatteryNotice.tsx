...
export const BatteryNotice: React.FC = () => {
  return (
    <div className="mt-6 mb-6 p-4 bg-gradient-to-r from-[#195061]/10 to-[#195061]/5 border-l-4 border-[#195061] rounded-md shadow-sm">
