...
export const BookingFormValidationMessage: React.FC = () => {
  return (
    <div className="my-4 py-4 px-6 bg-gray-50 rounded flex items-start">
      ...
      <span className="text-gray-700">
        Please fill in all required fields: <span className="bg-blue-100 px-1">Please select a time slot</span>
      </span>
    </div>
  );
};

export default BookingFormValidationMessage; 