...
const RecommendedTimeSlots: React.FC<RecommendedTimeSlotsProps> = ({ 
  ...
  const { firstSlot, secondSlot, loading, error, createdOrderNo } = useRecommendedSlots(formData, orderNo);
  ...
  return (
    <div className="mt-6">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                Next-day appointments are not available after 5:00 PM PST. The earliest available date is 2 days out.
              </p>
            </div>
          </div>
        </div>
      ...
      {error ? (
        ...
        <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No Available Slots Found</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              We couldn't find any available slots for your address at this time.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {firstSlot && (
          <div 
            ...
            className={`bg-green-50 dark:bg-green-900/20 rounded-lg p-6 cursor-pointer transition-all ${
                  isSlotSelected(firstSlot as TimeSlot) ? 'ring-2 ring-green-500 dark:ring-green-400' : 'hover:shadow-md'
            }`}
          >
            ...
            <div className="bg-white dark:bg-gray-900/40 rounded-lg p-6 border border-green-100 dark:border-transparent">
              ...
              <span className="text-gray-500 dark:text-gray-400">Best Choice</span>
            </div>
          </div>
        )}
        ...
        {secondSlot && (
          <div 
            ...
            className={`bg-green-50 dark:bg-green-900/20 rounded-lg p-6 cursor-pointer transition-all ${
                  isSlotSelected(secondSlot as TimeSlot) ? 'ring-2 ring-green-500 dark:ring-green-400' : 'hover:shadow-md'
            }`}
          >
            <div className="flex items-center mb-4">
              <svg className="w-5 h-5 text-green-600 dark:text-green-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white dark:bg-gray-900/40 rounded-lg p-6 border border-green-100 dark:border-transparent">
              ...
              <span className="text-gray-500 dark:text-gray-400">2nd Best Choice</span>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="text-center">
        ...
        >
          Pick Another Date
          <svg className="ml-2 h-6 w-6 text-white/90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
        </button>
      </div>
