...
const ProjectQuestions: React.FC<{
  formData: FormData;
  ...
  const handleDateSelect = async (date: Date | undefined) => {
    ...
    const drivers =
      formData.warehouse !== "Out of Region"
        ? driverMapping[formData.warehouse as Warehouse] || []
        : [];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const webhookResponse = await fetch(
        "https://webhooks.workato.com/webhooks/rest/49f37552-9667-45f9-a324-1b4f58455632/survey-optimo",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        <div className="w-full">
          ...
          <div className="bg-gray-50/50 dark:bg-gray-800/50 rounded-xl p-6 backdrop-blur-sm mb-8">
            <p className="text-gray-700 dark:text-gray-200">
              Please select any available slot. This reserves your preferred day
              - you&apos;ll receive a specific 2-hour arrival window the evening
              before via text and email, along with live tracking.
            </p>
            ...
            <div className="flex items-start space-x-2 mt-4 text-green-600 dark:text-gray-300">
              ...
              <p>
                Someone must be present during the survey to provide access to
                the attic, electrical equipment, and other areas of the
                property.
              </p>
            </div>
          </div>
